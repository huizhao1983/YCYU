		...
		<div class="ui alt segment" id="mainwp-favorite-themes">
			<div class="mainwp-main-content">
				<div class="ui labeled icon inverted menu mainwp-sub-submenu" id="mainwp-favorite-themes-menu">
					<a href="#" class="item" data-tab="mainwp-favorite-themes-tab"><i class="plug icon"></i> <?php _e( 'Favorite Themes', 'mainwp-favorites-extension' ); ?></a>
					<a href="#" class="item" data-tab="mainwp-favorite-theme-groups-tab"><i class="folder icon"></i> <?php _e( 'Favorite Themes Groups', 'mainwp-favorites-extension' ); ?></a>
				</div>
				<div class="ui message" id="mainwp-message-zone" style="display:none"></div>
				<div class="ui segment active tab" data-tab="mainwp-favorite-themes-tab">
          <table class="ui tablet stackable table" id="mainwp-favorite-themes-table">
            <thead>
              <tr>
            ...
            <tbody>
              <?php $this->get_table_content() ; ?>
				...
				<div class="ui segment tab" data-tab="mainwp-favorite-theme-groups-tab">
		      <table class="ui table" id="mainwp-favorite-theme-groups-table">
	          <thead>
							<tr>
	              <th class="check-column collapsing no-sort"><span class="ui checkbox"><input type="checkbox"></span></th>
