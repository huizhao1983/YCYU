  ...
  public static function endsWith( $haystack, $needle ) {
			...
			<?php if ( $current_tab == 'settings' ) : ?>
				<div class="ui alt segment" id="mainwp-favorites-settings">
					<div class="mainwp-main-content">
						...
						<?php Manage_Favorites::render_settings(); ?>
					</div>
					<div class="mainwp-side-content">
						...
						<a href="https://mainwp.com/help/docs/favorites-extension/" class="ui big green fluid button" target="_blank"><?php echo __( 'Extension Documentation', 'mainwp-favorites-extension' ); ?></a>
					</div>
	...
	static function render_groups( $type ) {
		...
		<div class="ui mini modal" type="<?php echo $type; ?>" id="mainwp-favorites-create-group-modal">
			<div class="header"><?php echo __( 'Crate Group', 'mainwp-favorites-extension' ); ?></div>
			<div class="content">
				<div class="ui form">
					<div class="field">
	...
	static function render_favorites( $type ) {
		?>
		<table class="ui tablet stackable single line table mainwp-favorites-table" type="<?php echo $type; ?>" id="mainwp-favorites-<?php echo $type; ?>-table">
			<thead>
				<tr>
	...
	public static function get_favorites_list_content( $type ) {
		...
		while ( $favorites && ( $favorite = @Favorites_Extension_DB::fetch_object( $favorites ) ) ) {
			...
			<tr class="mainwp-favorite mainwp-favorite-<?php echo $type; ?>" id="<?php echo $favorite->id; ?>" type="<?php echo $type; ?>" file="<?php echo $favorite->file; ?>">
				...
				<td class="right aligned"><a class="ui mini mainwp-favorite-delete mainwp-favorite-<?php echo $type ?>-delete" onClick="return managefavorite_remove(<?php echo "'" . $favorite->type . "', '" . $favorite->file . "', " . $favorite->id; ?>, this )"><?php echo __( 'Delete', 'mainwp-favorites-extension' ); ?></a></td>
			</tr>
			<?php
		}
